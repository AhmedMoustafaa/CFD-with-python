...
class DrawingApp:
    def __init__(self, root):
        ...
        self.canvas = tk.Canv as(root, bg="white")
        ...
        self.xs = []
        self.ys = []  # List to store drawn line y-coordinates
    ...
    def draw(self, event):
        if self.drawing:
            ...
            self.xs.append(x)
            self.ys.append(y)
            line = self.canvas.create_line(self.last_x, self.last_y, x, y, fill=self.pen_color, width=5)
